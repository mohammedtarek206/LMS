...
const CaseDetailsScreen = () => {
  ...
  const generatePDF = () => {
    ...
    const doc = new jsPDF();
    doc.setFontSize(22);
    doc.text('Fegma Lab', 105, 20, { align: 'center' });
    doc.setFontSize(14);
        ...
        <div style={{ borderBottom: '2px solid var(--border-color)', paddingBottom: '20px', marginBottom: '20px' }}>
          <div className="print-flex" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            ...
            <div style={{ textAlign: 'center', flex: 1 }}>
              <h1 style={{ color: '#000', margin: 0, fontSize: '28px' }}>فيجما لاب</h1>
              <h2 style={{ color: '#000', margin: '5px 0', fontSize: '20px' }}>Fegma Lab</h2>
